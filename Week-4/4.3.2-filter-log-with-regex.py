...
print(show_time_of_pid("Jul 16 14:01:23 computer.name CRON[29440]: USER (good_user)"))

# Jul 6 14:02:08 pid:29187
print(show_time_of_pid("Jul 16 14:02:08 computer.name jam_tag=psim[29187]: (UUID:006)"))
